...
--
-- Name: types_types_seq; Type: SEQUENCE; Schema: public; Owner: freecodecamp
--

CREATE SEQUENCE public.types_types_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.types_types_seq OWNER TO freecodecamp;

--
-- Name: types_types_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: freecodecamp
--

ALTER SEQUENCE public.types_types_seq OWNED BY public.types.type_id;
...
ALTER TABLE ONLY public.types ALTER COLUMN type_id SET DEFAULT nextval('public.types_types_seq'::regclass);
...
--
-- Name: types_types_seq; Type: SEQUENCE SET; Schema: public; Owner: freecodecamp
--

SELECT pg_catalog.setval('public.types_types_seq', 4, true);
